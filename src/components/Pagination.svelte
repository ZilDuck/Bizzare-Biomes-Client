<script type="ts">
  ...
  <div class="inline-block px-1 md:px-10 py-2 bg-white rounded-lg {className}">
    <nav class="flex md:space-x-4">
      <div>
        <p
          ...
          class='cursor-pointer relative flex items-center justify-center h-8 p-0 mx-1 text-xs font-semibold leading-tight text-gray-800 rounded-lg w-14 md:w-16 first:ml-0 hover:bg-gray-100'
        >
          &lt; Prev
        </p>
      </div>
        ...
        {#each Array.from({ length: numPages }) as _, i}
          <li>
            <p
              ...
              class='cursor-pointer relative flex items-center justify-center w-6 h-8 p-0 mx-1 text-xs font-semibold leading-tight rounded-lg md:w-8 first:ml-0 hover:bg-gray-100'
            >
              {i + 1}
            </p>
          </li>
      ...
      <div>
        <p
          ...
          class='cursor-pointer relative flex items-center justify-center h-8 p-0 mx-1 text-xs font-semibold leading-tight rounded-lg w-14 md:w-16 first:ml-0 hover:bg-gray-100'
        >
          Next &gt;
        </p>
      </div>
